...
| [Chitter-Challenge][5] | A test driven, lightweight twitter clone build from the ground up. | Ruby, Sinatra, RSpec, Capybara, PostgreSQL, HTML, CSS| 2 days |
...
Whilst working as a physiotherapist I was constantly challenged with different problems. This was one aspect I enjoyed most about Physiotherapy. Solving problems, big or small is something I thrive on. Since becoming a developer, I have found the approach to tackle problems or bugs is quite similar in how to diagnose a condition. For example, with complex injuries, I would break down the main issue into smaller problems. This allowed for clear visibility and the ability to prioritise problems in the same way it would whilst programming.
